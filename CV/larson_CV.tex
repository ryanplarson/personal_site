...
\begin{minipage}{0.45\linewidth}
  \begin{tabular}{ll}
    ...
    Web: & \href{https://cla.umn.edu/about/directory/profile/lars3965}{\tt https://cla.umn.edu/lars3965} \\
  \end{tabular}
\end{minipage}
...
\begin{itemize}
  \item Ph.D. Sociology, University of Minnesota - Twin Cities, 2014-present
   \begin{itemize}
...
\item  Jeanie Santaularia, \textbf{Ryan P. Larson}, Christopher Uggen. 2020. ``Criminal Punishment, Child Abuse, and Violent Injury in Minnesota." Forthcoming in \textit{Injury Epidemiology}.
...
\item Amber Hamilton, Doug Hartmann, and \textbf{Ryan P. Larson}. ``Measurements, Correlates, and Consequences of Colorblind Racism." Under review at \textit{DuBois Review}. 

\item Rob Stewart, Bieanna Watters, Veronica Horowitz, \textbf{Ryan Larson}, amd Christopher Uggen. ``Native Americans and Monetary Sanctions. Invited article to Russell Sage Foundation volume. 
...
\item  \textbf{Ryan Larson}, Chris Uggen, Sarah Shannon, and Aaron Sojourner. ``Prime-Age Labor Force Participation and Criminal Records". 
